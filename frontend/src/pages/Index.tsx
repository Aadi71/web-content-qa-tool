...
import { webContentService, WebContent, QAResponse } from '@/services/WebContentService';
...
const Index = () => {
  ...
  return (
    <div className="max-h-screen flex flex-col bg-gradient-to-b from-gray-50 to-gray-100">
      <header className="w-full bg-white shadow-sm py-4 px-6">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-2xl font-bold text-brand-700">Web Content Q&A Tool</h1>
          <p className="text-gray-500">Extract information and ask questions about web content</p>
        </div>
      </header>
          ...
          {processedContents.length > 0 && (
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="grid grid-cols-2 w-full rounded-none border-b">
                <TabsTrigger value="chat" className="rounded-none data-[state=active]:border-b-2 data-[state=active]:border-brand-600">
                  Q&A Chat
                </TabsTrigger>
                <TabsTrigger value="content" className="rounded-none data-[state=active]:border-b-2 data-[state=active]:border-brand-600">
              ...
              <TabsContent value="content" className="h-full overflow-y-auto p-4">
